...
public class SppdResource {
	...
	@Produces("application/json")
	public List<Retorno> cadastraPassageiro(
			...
			@PathParam("deficiente") String deficiente){
		...
		Passageiro p = new Passageiro(1, 
				...
				municipio, 
				nascimento, 
				Boolean.parseBoolean(deficiente));
	...
	@Produces("application/json")
	public List<LoginBean> logar(@PathParam("usuario") String usuario, 
